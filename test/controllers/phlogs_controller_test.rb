...
class PhlogsControllerTest < ActionController::TestCase
  ...
  test "should create phlog" do
    assert_difference('Phlog.count') do
      post :create, phlog: { description: @phlog.description, location: @phlog.location, pic: @phlog.pic, pic_processed: @phlog.pic_processed, title: @phlog.title }
    end
  ...
  test "should update phlog" do
    patch :update, id: @phlog, phlog: { description: @phlog.description, location: @phlog.location, pic: @phlog.pic, pic_processed: @phlog.pic_processed, title: @phlog.title }
    assert_redirected_to phlog_path(assigns(:phlog))
  end
